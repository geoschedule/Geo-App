...
export default class App extends React.Component {
  render() {
    return (
      <NativeRouter>
        <Switch>
          <Route exact path='/CameraView' render={(routeProps => < CameraView {...routeProps} socket={socket} />)} />
          <Route exact path='/Profile' render={(routeProps => < Profile {...routeProps} socket={socket} />)} />
